...
#     created_at = models.DateTimeField(default=datetime.now, blank=True)
#     uploader = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, null=True, blank=True, related_name="posts_photo") # L'utilisateur qui a téléchargé la photo est stocké ici
